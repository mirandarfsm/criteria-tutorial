...
export class MovieComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.movieService
      ...
      .subscribe(
        (res: HttpResponse<IMovie[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInMovies(): void {
    this.eventSubscriber = this.eventManager.subscribe('movieListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IMovie[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

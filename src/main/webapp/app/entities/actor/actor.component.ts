...
export class ActorComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.actorService
      ...
      .subscribe(
        (res: HttpResponse<IActor[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInActors(): void {
    this.eventSubscriber = this.eventManager.subscribe('actorListModification', () => this.loadPage());
  }
